...
/**
 *
 * @author (Isabela Muriel, Mateo Florez)
 * 
 */
class Proyecto
{
    ...
    private static float agenteViajeroAux(Digraph g, Camion camion, boolean[] visitado, float tiempo, ArrayList <Camion> ruta, ArrayList<Pair<Integer,Integer>> estaciones){ 
        ...
        for(int i = 0; i < g.size()-estaciones.size(); ++i){
            ...
            if(!hayTiempo(tNodos, tDepot, camion.st_customer, tSobrante)){
                ...
                System.out.print(actual+" "+" (" +tCamion+"Hrs), ");
            }
    ...
    public static void main(String[] args)throws IOException{
        ...
        Camion c = new Camion(125.0f, 40.0f, 1.0f, 0.5f, 16000.0f, 0);
        Camion c2 = new Camion(125.0f, 40.0f, 5.0f, 0.5f, 16000.0f, 0);
        //System.out.println(agenteViajero(g,c));
        //System.out.println(agenteViajero(g2,c2));
    }
}
